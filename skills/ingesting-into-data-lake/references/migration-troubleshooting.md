...
Frequently encountered problems when migrating Glue Data Catalog tables to S3 Tables.
...
For Glue-specific errors, refer to [glue-etl-migration.md](glue-etl-migration.md#troubleshooting).
