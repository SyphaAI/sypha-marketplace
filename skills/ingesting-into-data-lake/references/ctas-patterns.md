...
Replace Hive-style explicit partitions with Iceberg hidden partition transforms:
...
Athena CTAS is subject to a 100-partition limit per statement. Run the migration in batches:
