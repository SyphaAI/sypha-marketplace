...
Without indexes, every JSONB query performs a full table scan. Apply GIN indexes to accelerate containment-style queries.
...
Selecting the appropriate operator class:
