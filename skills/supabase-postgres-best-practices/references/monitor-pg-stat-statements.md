...
pg_stat_statements collects runtime statistics across all executed queries, making it straightforward to surface both slow and high-frequency problem queries.
