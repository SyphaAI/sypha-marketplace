...
Postgres does not create indexes on foreign key columns automatically. Absent indexes lead to slow JOINs and sluggish CASCADE operations.
...
Locate foreign key columns that have no index:
