...
PostgreSQL normalizes unquoted identifiers to lowercase. Once you quote a mixed-case identifier, you must continue quoting it everywhere, which creates friction with tools, ORMs, and AI assistants that may not handle them correctly.
...
Typical origins of mixed-case identifiers:
