...
Prepared statements belong to a specific database connection. Because transaction-mode pooling shares connections across requests, this creates conflicts.
...
Review your driver configuration:
