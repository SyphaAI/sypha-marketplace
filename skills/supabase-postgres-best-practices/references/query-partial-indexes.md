...
A partial index indexes only the rows that satisfy a given WHERE condition. When queries consistently apply the same filter, this produces a leaner, faster index than one covering the entire table.
