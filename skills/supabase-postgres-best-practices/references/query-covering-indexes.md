...
A covering index embeds every column a query needs, allowing PostgreSQL to satisfy the request from the index alone without touching the underlying table.
