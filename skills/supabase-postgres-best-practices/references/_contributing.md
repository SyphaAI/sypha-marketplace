...
This document outlines guidelines for producing effective Postgres best
practice references that function well with AI agents and LLMs.

## Key Principles

### 1. Concrete Transformation Patterns

Demonstrate exact SQL rewrites. Avoid abstract or philosophical advice.
...
Lead with the problematic pattern, then present the solution. This trains agents
...
Provide concrete metrics. This helps agents rank fixes by priority.
...
Examples should be complete and executable, or close to it. Include a
`CREATE TABLE` statement when the context requires it.
...
Choose meaningful table and column names. Names communicate intent to LLMs.
...
Most references should concentrate on pure SQL patterns to keep examples
portable.

**Include Application Code When:**

- Configuring connection pooling
- Managing transactions within an application context
- Illustrating ORM anti-patterns (N+1 in Prisma/TypeORM)
- Demonstrating prepared statement usage
...
- Postgres wiki
- Established technical blogs (2ndQuadrant, Crunchy Data)
...
Prior to submitting a reference:

- [ ] Title is clear and action-oriented
- [ ] Impact level reflects the actual performance gain
- [ ] impactDescription includes a quantified value
- [ ] Explanation is concise (1-2 sentences)
- [ ] Includes at least 1 **Incorrect** SQL example
- [ ] Includes at least 1 **Correct** SQL example
- [ ] SQL uses semantic naming
- [ ] Comments explain _why_, not _what_
- [ ] Trade-offs noted where applicable
- [ ] Reference links are present
- [ ] `pnpm test` passes
