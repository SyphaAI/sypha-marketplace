...
Allowing too many connections depletes memory and causes performance to deteriorate. Derive limits from available system resources.
...
Track current connection usage:
