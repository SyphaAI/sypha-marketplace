...
When table statistics fall out of date, the query planner is forced to make suboptimal choices. VACUUM reclaims dead storage while ANALYZE refreshes the statistics the planner relies on.
