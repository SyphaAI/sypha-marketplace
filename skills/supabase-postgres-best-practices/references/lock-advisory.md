...
Advisory locks enable application-level coordination using the database engine without needing to create or lock actual rows.
...
Non-blocking try-lock for opportunistic acquisition:
