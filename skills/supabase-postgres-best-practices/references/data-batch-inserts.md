...
Each individual INSERT carries significant per-statement overhead. Group multiple rows into a single statement, or use COPY for the best throughput.
...
For large-scale imports, use COPY:
