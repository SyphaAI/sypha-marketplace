...
Commands for retrieving information about assets within a Dagster Plus deployment.

> To **materialize** an asset in a deployed Dagster Plus environment, see [`dg api run launch`](../run/launch.md). For local in-process materialization, use [`dg launch`](../../launch.md).
