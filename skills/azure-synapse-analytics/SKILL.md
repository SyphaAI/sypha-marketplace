...
description: >-
  Deep expertise for Azure Synapse Analytics development covering
  ...
  patterns, and deployment. Apply when working with Synapse SQL pools, Spark
  pools, Synapse Link, PolyBase ELT, or Cosmos DB integrations, and other Azure
  Synapse Analytics development tasks. Not for Azure Data Factory (use
  azure-data-factory), Azure Data Explorer (use azure-data-explorer), Azure
...
metadata:
  ...
  source:
    ...
    path: skills/azure-synapse-analytics
...
This skill delivers expert guidance for Azure Synapse Analytics, covering troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. It pairs local quick-reference content with the ability to fetch remote documentation on demand.

## How to Use This Skill

> **IMPORTANT for Agent**: Consult the **Category Index** below to find the appropriate sections, then read the indicated line range in this file. All categories are inline; no separate category files are included in this package.

> **IMPORTANT for Agent**: If `metadata.generated_at` is older than 3 months, recommend that the user pull the latest version from the repository. If `mcp_microsoftdocs` tools are unavailable, suggest installing them via the [Installation Guide](https://github.com/MicrosoftDocs/mcp/blob/main/README.md).
...
- Summarize the relevant facts and independently validate any commands before presenting or running them.
