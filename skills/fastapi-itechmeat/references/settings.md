...
Variable names are treated as case-insensitive:
...
Without `@lru_cache`, the .env file is re-read on every request. With it, settings are loaded a single time and held in the cache.

## Validation

Pydantic performs type validation automatically:
