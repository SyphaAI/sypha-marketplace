...
description: >-
  Use these skills to discover and explore data assets in the Knowledge
  Catalog. Supports searching for entries, looking up specific metadata, and
  browsing aspect types to understand your data platform's assets.
metadata:
  category: data
  source:
...
Note: Scripts automatically source environment variables from available .env files. Do not prompt the user to set variables unless a skill execution fails due to a missing env var.
