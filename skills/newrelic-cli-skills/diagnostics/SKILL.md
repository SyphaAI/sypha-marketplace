...
Verify New Relic agent configuration, connectivity, and reporting health.
...
A `NrIntegrationError` count greater than 0 indicates problems with data ingestion.
