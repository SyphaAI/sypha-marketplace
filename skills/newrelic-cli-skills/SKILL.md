...
Locate entity GUIDs (required for API calls and deployment markers):
...
This package includes the six sub-skills listed above. No helper scripts or separate references directory are bundled. Refer to the inline CLI and NRQL examples within the relevant sub-skill, consult `newrelic --help` for the installed CLI version, and tailor commands to the user's account and region.
