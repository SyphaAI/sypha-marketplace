...
name: delta-sharing
description: >-
  Delta Sharing setup, monitoring, and recipient management for secure
...
Delta Sharing is an open protocol for securely sharing data across organizations. This skill covers share configuration, recipient management, access control, and usage monitoring.
...
Apply Delta Sharing when you need to:
...
- Keep share configuration under version control
- Conduct regular access reviews
- Establish clear data ownership
- Define SLAs for shared data
