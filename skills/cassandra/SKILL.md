...
Apache Cassandra is a peer-to-peer distributed database that delivers high availability with no single point of failure. Consistent hashing governs how data is spread across nodes.
