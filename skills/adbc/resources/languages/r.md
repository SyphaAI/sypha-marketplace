...
This feature first appeared in version 0.23.0 and is unavailable in older releases.

To use a connection profile, pass a `profile://` URI as the `uri` argument of `adbc_database_init`:
...
For more complete documentation, see https://arrow.apache.org/adbc/current/r/index.html.
