...
`AI.FORECAST` uses the pre-trained **TimesFM** foundation model to produce
forecasts, removing the overhead of training and maintaining custom models.
...
The output schema varies depending on the value of the `output_historical_time_series` flag.
