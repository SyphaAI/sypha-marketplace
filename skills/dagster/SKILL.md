...
name: dagster
description: >
  Dagster is a data pipeline orchestrator centered on the concept of
...
Dagster structures data pipelines around software-defined assets — explicit declarations of the data artifacts your pipeline creates. Assets provide lineage tracking, support incremental computation, and connect with the Dagster UI.
