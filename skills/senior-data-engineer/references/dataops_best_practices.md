...
A thorough reference for DataOps practices applied to production data systems.
...
### Slim CI Using State Comparison
...
## Overview
This runbook describes the procedures for responding to data pipeline failures.

## Severity Levels
- **P1 (Critical)**: Data is more than 24 hours old; revenue impact confirmed
- **P2 (High)**: Data is more than 4 hours old; customer-facing dashboards are affected
- **P3 (Medium)**: Data is more than 1 hour old; internal reports are delayed
- **P4 (Low)**: Non-critical pipeline; no measurable business impact
...
- Determine which downstream consumers are impacted
- Measure the current state of data freshness
...
- Outstanding follow-up action items

### 2. Update Monitoring
- Fill any gaps with missing alerts
- Revise alert thresholds as needed
- Enhance relevant documentation

### 3. Share Learnings
- Post a summary in #data-engineering
- Revise runbooks based on new findings
- Schedule a blameless postmortem for P1 or P2 incidents
```
