...
description: >-
  Data engineering skill for constructing scalable data pipelines, ETL/ELT systems,
  and data infrastructure. Covers Python, SQL, Spark, Airflow, dbt, Kafka,
  and the modern data stack. Encompasses data modeling, pipeline orchestration, data
  quality, and DataOps. Activate when architecting data systems, developing data
...
A production-grade data engineering skill for constructing scalable, reliable data systems.
...
Trigger this skill upon encountering:
...
Apply this framework to select the appropriate approach for your data pipeline.
...
- ML model training on historical data is required
- Complex batch transformations cannot be performed in streaming
- An existing batch infrastructure is already in place

**When to choose Kappa:**
- The system follows an event-sourced architecture
- Every processing step can be expressed as a stream operation
- Starting from scratch with no legacy systems
