...
description: Complete reference for Delta MERGE operations in streaming, covering performance tuning, parallel merges, and Liquid Clustering setup. Use when implementing upserts, tuning merge performance, running parallel merges to multiple tables, or removing optimize pauses.
---

# Merge Operations in Streaming

Complete reference for Delta MERGE operations: performance tuning, parallel merges to multiple tables, and modern Delta features (Liquid Clustering + Deletion Vectors + Row-Level Concurrency).
...
Activate modern Delta features to achieve optimal merge performance:
