...
description: >-
  Expert guidance covering Azure Data Factory development: troubleshooting,
  best practices, decision making, architecture & design patterns, limits &
  quotas, security, configuration, integrations & coding patterns, and
  deployment. Apply when working on ADF pipelines, data flows, integration
  runtimes, SAP CDC, CI/CD deployments, or SSIS migrations, plus other Azure
  Data Factory related development tasks. Not intended for Azure Synapse
  Analytics (use azure-synapse-analytics), Azure Databricks (use
  azure-databricks), Azure Stream Analytics (use azure-stream-analytics), Azure
  Functions (use azure-functions).
metadata:
  category: data
  source:
    repository: 'https://github.com/MicrosoftDocs/Agent-Skills'
    path: skills/azure-data-factory
...
This skill delivers expert guidance on Azure Data Factory, spanning troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. It pairs local quick-reference material with the ability to fetch remote documentation.
...
|----------|-------|-------------|
| Troubleshooting | L37-L90 | Identifying and resolving ADF issues — connector/format errors, pipeline and data flow failures, performance, CI/CD, security, and self-hosted/SSIS IR problems — with the help of logs and tools. |
| Best Practices | L91-L112 | ADF best practices for performance, DataOps, and reliability: tuning data flows/copy, optimizing sources/sinks/IR, dealing with schema drift/errors, and moving data (HDFS, Netezza, S3) to Azure. |
| Decision Making | L113-L131 | Help with ADF architecture and cost decisions: selecting runtimes/compute, connector upgrade strategy, reserved capacity, and planning/migrating pipelines and SSIS/Synapse to ADF or Fabric. |
| Architecture & Design Patterns | L132-L141 | ADF architectures and patterns: efficient mapping data flows, metadata‑driven copy, SSIS IR with SQL MI/failover/VNet, Cosmos DB migration, and SAP CDC design. |
| Limits & Quotas | L142-L147 | Reservation discounts for ADF data flows, pricing behavior, and the official limits/quotas (throughput, activities, pipelines, data flows) covered in the FAQ. |
| Security | L148-L178 | Protecting Data Factory through identity, encryption, Key Vault, and Azure Policy, alongside network controls such as VNets, Private Link, firewalls, private endpoints, and secure runtimes (Azure-SSIS, self-hosted). |
| Configuration | L179-L302 | Setting up Azure Data Factory: pipelines, activities, triggers, data flows, copy behavior, formats, integration runtimes (Azure/self-hosted/SSIS), monitoring, parameters, and SAP CDC settings. |
| Integrations & Coding Patterns | L303-L477 | How-tos and patterns for connecting ADF to many data sources, working with connectors, mapping data flow functions, activities, templates, and orchestrating Databricks, Synapse, SSIS, and ML jobs. |
| Deployment | L478-L491 | Deployment and CI/CD for ADF: ARM/linked templates, Azure DevOps pipelines, hotfix flows, pre/post scripts, IR automation, SSIS job migration, and runtime network migration. |
