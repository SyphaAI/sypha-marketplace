...
Generate content in streaming mode so the model sends output back incrementally rather than as a single block.
...
You can supply files directly using Google Cloud Storage URIs or local bytes.
