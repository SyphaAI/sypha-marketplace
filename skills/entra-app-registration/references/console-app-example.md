...
This document contains fully functional examples of console applications that authenticate against Microsoft Entra ID using MSAL (Microsoft Authentication Library).
...
- Consult [oauth-flows.md](oauth-flows.md) for details on each flow
- See [api-permissions.md](api-permissions.md) for permission configuration
