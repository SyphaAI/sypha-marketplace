...
Examine the data before documenting it, using discovering-data.

## Table level

Describe the table's grain, its purpose, and any edge cases
...
Calculated fields should carry a brief description of the transformation and its purpose.
