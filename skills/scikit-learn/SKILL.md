...
This skill delivers comprehensive guidance for machine learning tasks using scikit-learn, the industry-standard Python library for classical machine learning. Apply this skill for classification, regression, clustering, dimensionality reduction, preprocessing, model evaluation, and constructing production-ready ML pipelines.
...
A broad set of algorithms covering both classification and regression tasks.
...
Uncover patterns in unlabeled data through clustering and dimensionality reduction.
...
Tools for rigorous model evaluation, cross-validation, and hyperparameter tuning.
...
Convert raw data into formats appropriate for machine learning.
...
- Generating non-linear features for linear models
...
Run a complete classification workflow covering preprocessing, model comparison, hyperparameter tuning, and evaluation:
...
This skill includes comprehensive reference files for in-depth coverage of specific topics:
...
Pipelines prevent data leakage and maintain consistency:
```python
