...
In-depth authentication flows and OAuth configuration options.

## Authentication Flows

### USER_SRP_AUTH (Recommended)

Secure Remote Password protocol — the password is never transmitted over the network.
...
Sends username and password directly (must be enabled in client settings).
...
A custom authentication flow driven by Lambda triggers.
