...
description: >-
  Use the Angular CLI and development tools efficiently in Angular v20+
  projects. Covers project setup, code generation, building, testing, and
  configuration. Activates when creating new projects, generating
  components/services/modules, configuring builds, running tests, or tuning
  production builds. Not for Nx workspace commands, custom Webpack
  configurations, or build systems outside the Angular CLI such as standalone
  Vite or direct esbuild usage.
metadata:
...
Use the Angular CLI and development tooling to work productively on Angular v20+ projects.
...
Configure this in angular.json:
...
Refer to [references/tooling-patterns.md](references/tooling-patterns.md) for advanced configuration details.
