...
Leave `"schema": []` and click "Import schema" in the UI, or specify mappings in the Copy activity translator.

---

## Dataset Parameters Usage

Inside a pipeline Copy activity:
```json
{
  "inputs": [
    {
...
With Mapping Data Flows, inline datasets make separate dataset objects unnecessary:
