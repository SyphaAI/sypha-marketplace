...
description: >-
  Configure routing in Angular v20+ applications with lazy loading, functional
  guards, resolvers, and route parameters. Covers navigation setup, protected
  routes, route-based data loading, and nested routing. Triggers when
  setting up routes, adding authentication guards, enabling lazy loading, or
...
Configure Angular v20+ routing with lazy loading, functional guards, and signal-based route parameters.
...
Defer feature loading until it is actually required:
...
Enable this by adding `withComponentInputBinding()`:
...
Pre-fetch data before a route becomes active:
