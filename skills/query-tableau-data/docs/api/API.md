...
The APIs in this directory follow a three-phase pipeline: **Discover** assets in the catalog, **Introspect** their schemas to understand queryable fields, then **Execute** queries to retrieve data.
