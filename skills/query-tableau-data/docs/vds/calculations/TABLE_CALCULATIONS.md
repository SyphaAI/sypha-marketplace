...
Every table calculation field requires a `tableCalculation` property on the field object. This property determines which operation is applied and how the result set is partitioned.
