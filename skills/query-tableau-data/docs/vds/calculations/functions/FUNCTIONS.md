...
Functions are the foundational building blocks of calculations in Tableau. They transform, aggregate, and evaluate data by accepting arguments — fields, literals, parameters, or nested functions — and returning a result. Nearly every VDS calculation that goes beyond simple arithmetic depends on one or more of the function categories listed below.

For a broader introduction to calculations and how functions relate to fields, operators, and literals, see [CALCULATIONS.md](../CALCULATIONS.md).
