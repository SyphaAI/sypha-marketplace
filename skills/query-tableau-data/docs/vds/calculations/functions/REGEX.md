...
Regular expression functions are supported in VDS queries when the underlying data source is compatible. For Tableau extracts, the regular expression syntax follows the ICU (International Components for Unicode) library standard.
