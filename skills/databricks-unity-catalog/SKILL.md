...
description: >-
  Unity Catalog system tables and volumes. Invoke when querying system tables
  (audit, lineage, billing) or performing volume file operations (upload,
...
Reference material for Unity Catalog system tables, volumes, and governance.
...
1. **Filter by date** - System tables can be large; always include date filters
2. **Use appropriate retention** - Review your workspace's retention configuration
3. **Grant minimal access** - System tables hold sensitive metadata
4. **Schedule reports** - Set up scheduled queries for ongoing monitoring
