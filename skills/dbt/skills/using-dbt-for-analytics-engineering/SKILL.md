...
description: Constructs and updates dbt models, authors SQL transformations with ref() and source(), generates tests, and confirms results using dbt show. Apply when performing any dbt work - building or modifying models, diagnosing errors, exploring unfamiliar data sources, authoring tests, or assessing the impact of changes.
