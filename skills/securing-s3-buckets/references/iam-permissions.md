...
The table below lists the minimum IAM permissions required for each workflow. Run `aws iam simulate-principal-policy` to validate effective permissions before executing any write operations.
