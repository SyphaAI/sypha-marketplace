<h1 align="center">Sypha Marketplace</h1>

A curated collection of **Skills**, **MCP Servers**, and **Agents** for enhancing AI agent capabilities across the Sypha ecosystem—including Sypha Code (VS Code extension), Sypha CLI, and compatible AI agents.

---

## What is the Sypha Marketplace?

The Sypha Marketplace is a community-driven repository of agent tooling prompts and configurations. It provides three types of resources that extend what AI agents can do:
...
Skills follow the open [Agent Skills specification](https://agentskills.io/), making them interoperable across any compatible AI agent—not just Sypha.
