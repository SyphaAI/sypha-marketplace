...
All contributed skills must reference an external repository in the `metadata.source` section of the SKILL.md frontmatter. The Sypha Marketplace does not host the source code for third-party skills directly. See [CONTRIBUTING.md](CONTRIBUTING.md#skills-must-be-hosted-externally) for details and examples.
...
use the instructions in .sypha/skills/add-remote-skill/SKILL.md
